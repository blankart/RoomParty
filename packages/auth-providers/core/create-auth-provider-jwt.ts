...
export default function createAuthProviderJwt(jwt: typeof Jwt, options: CreateAuthProviderJwtOptions) {
    if (!options.secret) {
        throw new Error('Error while creating jwt signer and verifier: `secret` is not set.')
    }
