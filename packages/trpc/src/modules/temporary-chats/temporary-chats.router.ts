...
class TemporaryChatsRouter {
    constructor(
        @inject(CONTROLLER_TYPES.TemporaryChats) private temporaryChatsController: TemporaryChatsController,
        ...
        return this.trpcRouter
            ...
            .subscription('chatSubscription', {
                ...
                async resolve({ ctx, input }) {
                    return await self.temporaryChatsController.chatSubscription(input, ctx.user)
                }
            })
    }
}
