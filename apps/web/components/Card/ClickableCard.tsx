...
export default function ClickableCard(props: ClickableCardProps) {
  const wrapperClassName = classNames(
    "overflow-hidden rounded-lg bg-base-200 duration-100 border-2 border-transparent hover:border-secondary flex md:block",
    props.className
  );
  let content = (
    <>
      {props.imgSrc ? (
        ...
        <div className="!m-0 aspect-video max-h-[150px] bg-secondary object-cover !w-full" />
      )}
