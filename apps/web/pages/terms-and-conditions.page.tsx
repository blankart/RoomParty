...
export default function TermsAndConditions() {
  const title = `Terms and Conditions - ${APP_NAME}`;
  const canonical =
    process.env.NEXT_PUBLIC_WEB_BASE_URL + "/terms-and-conditions";
  return (
    <>
      <NextSeo
        title={title}
      ...
      />
      <div className="container p-4 mx-auto prose-sm lg:prose-lg">
        <h2>
          <strong>Terms and Conditions</strong>
        </h2>

        <p>Welcome to RoomParty!</p>
        ...
        <p>
          ...
          conditions. Do not continue to use RoomParty if you do not agree to
        ...
        <p>
          Unless otherwise stated, RoomParty and/or its licensors own the
          intellectual property rights for all material on RoomParty. All
          intellectual property rights are reserved. You may access this from
          RoomParty for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from RoomParty</li>
          <li>Sell, rent or sub-license material from RoomParty</li>
          <li>Reproduce, duplicate or copy material from RoomParty</li>
          <li>Redistribute content from RoomParty</li>
        </ul>
        ...
        <p>
          ...
          RoomParty does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of RoomParty,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, RoomParty shall
        ...
        <p>
          RoomParty reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant RoomParty a non-exclusive license to use, reproduce,
        ...
        <p>
          ...
          the hyperlink compensates the absence of RoomParty; and (d) the link
        ...
        <p>
          ...
          sending an e-mail to RoomParty. Please include your name, your
