...
export default function PrivacyPolicyPage() {
  ...
  const canonical = process.env.NEXT_PUBLIC_WEB_BASE_URL + "/privacy-policy";
  return (
    <>
      <NextSeo
        title={title}
      ...
      <div className="container p-4 mx-auto prose-sm lg:prose-lg">
        ...
        <p>
          Welcome to <b> RoomParty</b>.
        </p>
        <p>
          <b>RoomParty</b> (“us”, “we”, or “our”) operates <b>roomparty.com</b>{" "}
          (hereinafter referred to as <b>“Service”</b>).
        </p>
        <p>
          Our Privacy Policy governs your visit to <b>roomparty.com</b>, and
        ...
        <p>
          <b>SERVICE</b> means the roomparty.com website operated by RoomParty.
        </p>
        <p>
        ...
        <p>RoomParty uses the collected data for various purposes:</p>
        ...
        <p>
          RoomParty will take all the steps reasonably necessary to ensure that
